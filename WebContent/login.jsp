...
<div class="container bc-gray">
	<div class="row bc-orange" style="padding-top: 40px; padding-bottom: 40px;">
		<div class="col-md-10 offset-md-1 bc-green" style="border-radius: 10px; padding-top: 40px; padding-bottom: 40px;">
			<form class="bc-yellow col-md-12">
			  <div class="form-group bc-pink">
			    <label for="input_id">ID</label>
			    <input type="text" class="form-control" id="input_id" placeholder="IDを入力してください">
			  </div>
			  <div class="form-group bc-indigo">
